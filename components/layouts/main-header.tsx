...
function MainHeader() {
  ...
  return (
    <header
      className={`site-header sticky top-0 left-0 right-0 z-[999] py-4 bg-secondary transition-all duration-300 [&.stickyHeader]:shadow-[0_0_15px_rgba(0,0,0,.5)] ${sticky}`}
    >
